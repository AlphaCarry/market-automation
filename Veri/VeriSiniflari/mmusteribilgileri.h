#ifndef MMUSTERIBILGILERI_H
#define MMUSTERIBILGILERI_H

#include <QObject>
#include<Veri/tanimlar.h>

class MMusteriBilgileri : public QObject
{
    Q_OBJECT
public:
    explicit MMusteriBilgileri(QObject *parent = nullptr);
